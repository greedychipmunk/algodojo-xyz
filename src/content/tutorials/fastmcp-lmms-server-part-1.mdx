---
title: "Build an LMMS MCP Server with FastMCP (Part 1): Parsing and Analyzing DAW Projects"
...
```
┌──────────────┐     MCP (stdio)     ┌──────────────────┐     reads/writes     ┌────────────────┐
│  Claude or   │ ◄──────────────────► │  LMMS MCP Server │ ◄──────────────────► │  .mmp / .mmpz  │
│  any MCP     │   JSON-RPC over      │  (FastMCP +      │    XML / zlib        │  project files  │
│  client      │   stdin/stdout       │   Python)        │                      │  on disk        │
└──────────────┘                      └──────────────────┘                      └────────────────┘
```
