---
title: "Orchestrate Codex Agents with the Letta Agent SDK"
slug: "letta-orchestrate-codex"
description: "The full SDK approach: build a TypeScript orchestrator with the Letta Agent SDK that dispatches tasks to Codex CLI agents, streams messages, resumes sessions, and runs parallel investigations. For developers who want maximum control over the orchestration pipeline."
tier: "free"
category: "ai"
...
> **This is one of three tutorials on orchestrating Codex with Letta.** This guide covers the full Agent SDK approach — a TypeScript orchestrator with streaming, session resumption, and parallel dispatch. For a quicker path, see [Dispatch Codex Agents with the Letta Code Skill](/tutorials/letta-dispatch-codex-skill) (zero setup) or [Add a Codex Tool to a Letta Agent via API](/tutorials/letta-codex-tool-api) (minimal Python).
